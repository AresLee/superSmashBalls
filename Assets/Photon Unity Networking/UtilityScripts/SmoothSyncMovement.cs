 ...
 //           stream.SendNext(transform.position);
    ...
    public void Update()
    {
        if (!photonView.isMine)
        {
			...
			gameObject.GetComponent<Rigidbody>().velocity=Vector3.Lerp(gameObject.GetComponent<Rigidbody>().velocity, correctPlayerVelocity, Time.deltaTime * this.SmoothingDelay);
        }
    }
